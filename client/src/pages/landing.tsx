  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white overflow-x-hidden">
      <section className="relative min-h-screen flex flex-col justify-center overflow-hidden">
        <div className="absolute inset-0 pointer-events-none" style={{ backgroundImage: "linear-gradient(rgba(39,39,42,.4) 1px, transparent 1px), linear-gradient(90deg, rgba(39,39,42,.4) 1px, transparent 1px)", backgroundSize: "60px 60px" }} />
        ...
        <nav className="relative z-10 flex items-center justify-between px-4 md:px-8 py-4 max-w-7xl mx-auto w-full">
          ...
          <div className="flex items-center gap-3">
            <Link href="/auth"><Button variant="ghost" size="sm" className="text-zinc-400 hover:text-white" data-testid="link-sign-in">Sign In</Button></Link>
            <Link href="/auth"><Button size="sm" className="bg-emerald-500 hover:bg-emerald-600 text-white border-emerald-600" data-testid="link-sign-up-nav">Get Started</Button></Link>
          </div>
        </nav>
          ...
          <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
            <div className={fadeInUp}>
              <Badge className="mb-6 bg-emerald-500/10 text-emerald-400 border-emerald-500/20 hover:bg-emerald-500/10 px-3 py-1 text-xs font-medium">
                <Zap className="w-3 h-3 mr-1" /> 500+ S&P 500 + NASDAQ 100 tickers scanned daily
              </Badge>
            </div>
        ...
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 animate-bounce"><ChevronDown className="w-5 h-5 text-zinc-500" /></div>
      </section>
            ...
            {features.map((f, i) => (
              <AnimatedSection key={f.title} delay={(i % 2) * 100}>
                <div className="flex gap-4 p-5 rounded-xl border border-zinc-800/60 bg-zinc-900/30 hover:bg-zinc-900/60 transition-colors h-full">
                  <div className="w-10 h-10 rounded-lg bg-emerald-500/10 flex items-center justify-center shrink-0 mt-0.5"><f.icon className="w-5 h-5 text-emerald-400" /></div>
                  <div><h3 className="text-sm font-semibold text-white mb-1">{f.title}</h3><p className="text-sm text-zinc-400 leading-relaxed">{f.desc}</p></div>
                </div>
              </AnimatedSection>
            ))}
          </div>
      ...
      <section className="relative py-20 md:py-28 px-4">
        <div className="max-w-5xl mx-auto">
          <AnimatedSection><div className="text-center mb-10"><h2 className="text-2xl md:text-3xl font-bold text-white mb-3">Your Trading Command Center</h2><p className="text-zinc-400 text-sm md:text-base">Real data. Updated every trading day.</p></div></AnimatedSection>
          <AnimatedSection delay={100}><MockDashboardFull /></AnimatedSection>
        </div>
      </section>
      ...
      <section id="pricing" className="relative py-20 md:py-28 px-4">
        <div className="max-w-md mx-auto">
          <AnimatedSection><div className="text-center mb-10"><h2 className="text-2xl md:text-3xl font-bold text-white mb-3">Simple Pricing</h2><p className="text-zinc-400 text-sm md:text-base">One plan. Everything included.</p></div></AnimatedSection>
          <AnimatedSection delay={100}>
            <Card className="bg-zinc-900/60 border-zinc-700/50 p-6 md:p-8 relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <Link href="/auth"><Button className="w-full bg-emerald-500 hover:bg-emerald-600 text-white border-emerald-600" size="lg" data-testid="button-pricing-cta">Start Free Preview <ArrowRight className="w-4 h-4 ml-1" /></Button></Link>
                <p className="text-xs text-zinc-500 text-center mt-4">Free preview shows limited data. No credit card required to start.</p>
              </div>
            </Card>
          </AnimatedSection>
        </div>
      ...
      <section id="faq" className="relative py-20 md:py-28 px-4">
        <div className="max-w-2xl mx-auto">
          <AnimatedSection><div className="text-center mb-10"><h2 className="text-2xl md:text-3xl font-bold text-white mb-3">Frequently Asked Questions</h2></div></AnimatedSection>
